...
export class PersonaClienteController {
  ...
  async find(
    ...
    return this.personaRepository.personaAcliente(id).find(filter);
  }
  ...
  async create(
    ...
    return this.personaRepository.personaAcliente(id).create(cliente);
  }
  ...
  async patch(
    ...
    return this.personaRepository.personaAcliente(id).patch(cliente, where);
  }
  ...
  async delete(
    ...
    return this.personaRepository.personaAcliente(id).delete(where);
  }
}
