...
export class AdministradorAsesorController {
  ...
  async find(
    ...
    return this.administradorRepository.adminAasesor(id).find(filter);
  }
  ...
  async create(
    ...
    return this.administradorRepository.adminAasesor(id).create(asesor);
  }
  ...
  async patch(
    ...
    return this.administradorRepository.adminAasesor(id).patch(asesor, where);
  }
  ...
  async delete(
    ...
    return this.administradorRepository.adminAasesor(id).delete(where);
  }
}
