...
export class ClienteMascotaController {
  ...
  async find(
    ...
    return this.clienteRepository.clienteAmascota(id).find(filter);
  }
  ...
  async create(
    ...
    return this.clienteRepository.clienteAmascota(id).create(mascota);
  }
  ...
  async patch(
    ...
    return this.clienteRepository.clienteAmascota(id).patch(mascota, where);
  }
  ...
  async delete(
    ...
    return this.clienteRepository.clienteAmascota(id).delete(where);
  }
}
